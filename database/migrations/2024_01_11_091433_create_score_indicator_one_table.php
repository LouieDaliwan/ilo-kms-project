...
return new class extends Migration
{
    ...
    {
        Schema::create('score_indicator_one', function (Blueprint $table) {
            $table->id();
            $table->integer('is_read_privacy_statement')->index()->default(0);
            $table->string('gender')->index();
            $table->string('country_workplace')->index()->nullable();
            ...
            $table->longText('cite_examples')->nullable();
    ...
    {
        Schema::dropIfExists('score_indicator_one');
    }
};
