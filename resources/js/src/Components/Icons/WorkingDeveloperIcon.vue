...
<template>
    ...
    >
        ...
        <rect
            ...
            y="154.61"
        />
        <rect fill="#fff" height="7.8" width="98.53" x="213.02" y="141.26" />
        <rect fill="#fff" height="7.8" width="65.96" x="325.02" y="141.26" />
        <rect fill="#fff" height="6.93" width="101.41" x="289.34" y="91.88" />
        <rect
            fill="#fff"
            height="6.93"
            opacity="0.51"
            ...
            y="104.19"
        />
        <rect fill="#fff" height="6.93" width="66.7" x="214.9" y="91.88" />
        <rect fill="#fff" height="6.93" width="146.59" x="244.16" y="116.13" />
        <rect
            fill="#fff"
            height="6.93"
            opacity="0.51"
        ...
        <rect
            ...
            y="128.44"
        />
        <rect fill="#fff" height="6.93" width="66.7" x="214.9" y="128.44" />
        <rect fill="#fff" height="6.93" width="42.89" x="214.9" y="103.9" />
        <rect fill="#fff" height="6.93" width="101.41" x="252.25" y="68.55" />
        <rect
            fill="#fff"
            height="6.93"
            opacity="0.51"
            ...
            y="80.86"
        />
        <rect fill="#fff" height="6.93" width="66.7" x="177.82" y="68.55" />
        <rect fill="#fff" height="6.93" width="101.41" x="251.35" y="54.2" />
        <rect fill="#fff" height="6.93" width="66.7" x="176.92" y="41.18" />
        <rect fill="#fff" height="6.93" width="66.7" x="176.92" y="29.3" />
        <rect fill="#fff" height="6.93" width="42.89" x="177.82" y="80.57" />
    </svg>
</template>
