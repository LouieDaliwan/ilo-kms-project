...
<template>
    <admin>
        ...
        <div class="mt-15">
            ...
            <v-progress-linear color="rgb(250,60,75)" bg-color="#303DC3" model-value="20" :height="12"></v-progress-linear>
        </div>
        <div class="mt-15">
            <h3>OSH Knowledge Assessment</h3>
            <p>The percentage of workers reporting an improved understanding of their rights and duties related to OSH issues.</p>
            <v-row class="mt-5">
                <v-col>
                    <PieChart />
                </v-col>
