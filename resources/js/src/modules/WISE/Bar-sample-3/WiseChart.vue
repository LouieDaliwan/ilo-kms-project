<template>
    <div>
        <canvas id="wise-chart3" height="40" width="70"></canvas>
    </div>
</template>
...
export default {
    ...
    mounted() {
        // const ctx = document.getElementById("wise-chart3");
        ...
        getResources() {
            axios
                ...
                .then((response) => {
                    ...
                    this.chart.data.datasets[0].data = response.data.third_question
                    this.chart.update();
