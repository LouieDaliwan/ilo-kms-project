<template>
    <div>
        <canvas id="wise-chart4" height="40" width="70"></canvas>
    </div>
</template>
...
export default {
    ...
    mounted() {
        // const ctx = document.getElementById("wise-chart4");
        ...
        getResources() {
            axios
                ...
                .then((response) => {
                    ...
                    this.chart.data.datasets[0].data = response.data.fourth_question
                    this.chart.update();
