<template>
    <div>
        <canvas id="wise-chart8" height="40" width="70"></canvas>
    </div>
</template>
...
export default {
    ...
    mounted() {
        // const ctx = document.getElementById("wise-chart8");
        ...
        getResources() {
            axios
                ...
                .then((response) => {
                    ...
                    this.chart.data.datasets[0].data = response.data.sixth_question
                    this.chart.update();
